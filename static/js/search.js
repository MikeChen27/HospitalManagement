...
jq(document).ready( function(jq) {
    ...
    jq('#sear_pat').click(function (event) {
    ...
    jq('#sear_cg').click(function (event) {
        event.preventDefault();
        a = jq('#rid').val();
        b = jq('#cgid').val();
        c = jq('#lb').val();
    ...
    jq('#sear_adm').click(function (event) {
        event.preventDefault();
        a = jq('#rid').val();
        b = jq('#sjid').val();
        c = jq('#hid').val(),
    ...
    jq('#sear_cpt').click(function (event) {
        event.preventDefault();
        a = jq('#rid').val();
        b = jq('#sjid').val();
        c = jq('#hid').val();
    ...
    jq('#sear_pre').click(function (event) {
        event.preventDefault();
        a = jq('#rid').val();
        b = jq('#sjid').val();
        c = jq('#hid').val(),
    ...
    jq('#sear_dt').click(function (event) {
        event.preventDefault();
        a = jq('#rid').val();
        b = jq('#sjid').val();
        c = jq('#hid').val(),
    ...
    jq('#sear_lab').click(function (event) {
        event.preventDefault();
        a = jq('#rid').val();
        b = jq('#sjid').val();
        c = jq('#hid').val(),
    ...
    jq('#jp_adm').click(function(event){
        event.preventDefault();
        location.href = "/search/admission";
    });
    ...
    jq('#jp_cg').click(function(event){
        event.preventDefault();
        location.href = "/search/caregiver";
    });

    jq('#jp_cpt').click(function(event){
        event.preventDefault();
        location.href = "/search/cpt";
    });

    jq('#jp_dt').click(function(event){
        event.preventDefault();
        location.href = "/search/datatimeevent";
    });

    jq('#jp_lab').click(function(event){
        event.preventDefault();
        location.href = "/search/labevent";
    });

    jq('#jp_pre').click(function(event){
        event.preventDefault();
        location.href = "/search/prescription";
    });
